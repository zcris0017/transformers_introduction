...
The file transformer.py focused on the transformers structure. I will soon update the Complete_Model.py, which describes how we sett up and train the whole model described in the blog, by the end of August.
